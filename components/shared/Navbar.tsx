...
export function Navbar() {
  ...
  return (
    <div className="relative z-20 w-full" id="home">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8  xl:border-b xl:border-muted-foreground/40 ">
        <div className="inline-flex items-center space-x-2">
          ...
          <span className="text-lg font-bold">
            PDF <span className="text-pretty text-primary">MERGE</span>
          </span>
        </div>
          ...
          <ul className="inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <a
                  href={item.href}
                  className="text-base font-semibold text-secondary-foreground hover:text-primary"
                >
                  {item.name}
                </a>
              </li>
